          ...
          <View style={styles.detailsCard}>
            ...
            {!detailsItem ? (
              ...
              <ScrollView style={{ maxHeight: 520 }} contentContainerStyle={{ paddingBottom: 10 }}>
                ...
                {!!detailsItem?.previousEnumeration && (
                  <View style={{ marginTop: 6, marginBottom: 8, padding: 10, backgroundColor: 'rgba(5, 150, 105, 0.05)', borderRadius: 12, borderWidth: 1, borderColor: 'rgba(5, 150, 105, 0.2)' }}>
                    <Text style={[styles.sectionTitle, { marginTop: 0, marginBottom: 8, fontSize: 13, color: '#047857' }]}>
                      Previous Record Details
                    </Text>
                    <View style={styles.kvRow}>
                      <Text style={styles.kvKey}>Prev Takki No.</Text>
                      <Text style={styles.kvVal}>{detailsItem.previousEnumeration.takki_number || '-'}</Text>
                    </View>
                    <View style={styles.kvRow}>
                      <Text style={styles.kvKey}>Prev Page No.</Text>
                      <Text style={styles.kvVal}>{detailsItem.previousEnumeration.page_no || '-'}</Text>
                    </View>
                    <View style={styles.kvRow}>
                      <Text style={styles.kvKey}>Prev Reg No.</Text>
                      <Text style={styles.kvVal}>{detailsItem.previousEnumeration.register_no || '-'}</Text>
                    </View>
                    <View style={styles.kvRow}>
                      <Text style={styles.kvKey}>Prev Girth</Text>
                      <Text style={styles.kvVal}>{detailsItem.previousEnumeration.girth || '-'}</Text>
                    </View>
                    <View style={styles.kvRow}>
                      <Text style={styles.kvKey}>Prev Species</Text>
                      <Text style={styles.kvVal}>{detailsItem.previousEnumeration.species?.name || '-'}</Text>
                    </View>
                    <View style={styles.kvRow}>
                      <Text style={styles.kvKey}>Prev Condition</Text>
                      <Text style={styles.kvVal}>{detailsItem.previousEnumeration.condition?.name || '-'}</Text>
                    </View>
                    {!!detailsItem.previousEnumeration.rd_km && (
                      <View style={styles.kvRow}>
                        <Text style={styles.kvKey}>Prev RD/KM</Text>
                        <Text style={styles.kvVal}>{detailsItem.previousEnumeration.rd_km}</Text>
                      </View>
                    )}
                  </View>
                )}
